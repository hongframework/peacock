    ...
    public static void main(String[] args) throws Throwable {
        try {
            ...
            try {
                ...
                tProperties.load(HFrameworkBootstrap.class.getClassLoader().getResourceAsStream("node.properties"));
                for (Entry<Object, Object> entry : tProperties.entrySet()) {
                    System.setProperty(String.valueOf(entry.getKey()).trim(), (String) entry.getValue());
                }
            }catch (Exception e) {}
