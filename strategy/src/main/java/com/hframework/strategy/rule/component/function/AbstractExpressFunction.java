 ...
 */
public abstract class AbstractExpressFunction implements IFunction {
    @Override
    public String execute(String express) {
        ...
        for (String functionBody : matchSet) {
            express = parseFunction(express, functionBody);
        }
        return express;
    }

    protected  String parseFunction(String express, String functionBody){
        ...
        return invokeFunction(express, functionBody, keyword, parameters);
    }

    protected abstract String invokeFunction(String express, String functionBody, String keyword, String[] parameters);

    @Override
    public String removeTemp(String express) {
        return express.replaceAll(getPattern(), "");
    }
