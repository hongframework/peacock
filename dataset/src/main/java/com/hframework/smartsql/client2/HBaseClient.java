...
//        }
        ...
        ResultScanner hamster_statistics_runtime = hBaseClient.scan("hamster_statistics_runtime", "user_newly_increased_");

        Map<String, BigDecimal> results = new HashMap<>();
        for (Result result : hamster_statistics_runtime) {
        ...
        Result result = hBaseClient.get("hamster_statistics_hour", "00_1039_21170311");
        System.out.println(resultGet(result, "infos", "name"));
        hBaseClient.putter().table("hamster_statistics_hour")
                .rowKey("00_1039_21170311")
                .column("infos", "testDouble", 1.30d)
                .column("infos", "name", "这是一个测试信息").put();

        result = hBaseClient.get("hamster_statistics_hour", "00_1039_21170311");
        System.out.println(resultGet(result, "infos", "name"));
        System.out.println(resultGet(result, "infos", "testDouble"));
        hBaseClient.delete("hamster_statistics_hour", "00_1039_21170311");
