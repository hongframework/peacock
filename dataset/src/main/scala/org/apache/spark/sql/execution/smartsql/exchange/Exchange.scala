...
import org.apache.spark.sql.execution.smartsql.{LeafExecNode, SparkPlan, UnaryExecNode}
...
case class ReusedExchangeExec(override val output: Seq[Attribute], child: Exchange)
  ...
  def doExecute(parameters : Map[String, Any] = Map.empty[String, Any]): ResultSet[InternalRow] = {
