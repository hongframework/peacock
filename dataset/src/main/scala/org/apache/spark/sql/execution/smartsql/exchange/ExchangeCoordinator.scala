...
import org.apache.spark.sql.execution.smartsql.{ShuffledRowRDD, SparkPlan}
    ...
    val targetPostShuffleInputSize = minNumPostShufflePartitions match {
      case Some(numPartitions) =>
        ...
        val maxPostShuffleInputSize =
          scala.math.max(scala.math.ceil(totalPostShuffleInputSize / numPartitions.toDouble).toLong, 16)
        scala.math.min(maxPostShuffleInputSize, advisoryTargetPostShuffleInputSize)
