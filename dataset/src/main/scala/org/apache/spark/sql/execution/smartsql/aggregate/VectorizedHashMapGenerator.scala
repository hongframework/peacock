...
class VectorizedHashMapGenerator(
  ...
  override protected def initializeAggregateHashMap(): String = {
    ...
    s"""
       |  private org.apache.spark.sql.execution.smartsql.vectorized.ColumnarBatch batch;
       |  private org.apache.spark.sql.execution.smartsql.vectorized.ColumnarBatch aggregateBufferBatch;
       |  private int[] buckets;
       ...
       |    batch = org.apache.spark.sql.execution.smartsql.vectorized.ColumnarBatch.allocate(schema,
       |      org.apache.spark.memory.MemoryMode.ON_HEAP, capacity);
       |    // TODO: Possibly generate this projection in HashAggregate directly
       |    aggregateBufferBatch = org.apache.spark.sql.execution.smartsql.vectorized.ColumnarBatch.allocate(
   ...
   * associated [[org.apache.spark.sql.execution.smartsql..ColumnarBatch]]. For instance, if we
   ...
   * [[org.apache.spark.sql.execution.smartsql..ColumnarBatch.Row]] which keeps track of the
   ...
   * [[org.apache.spark.sql.execution.smartsql..ColumnarBatch]]. For instance, if we
   * have 2 long group-by keys, the generated function would be of the form:
   *
   * {{{
   * public org.apache.spark.sql.execution.smartsql.vectorized.ColumnarBatch.Row findOrInsert(
  ...
  protected def generateRowIterator(): String = {
    s"""
       |public java.util.Iterator<org.apache.spark.sql.execution.smartsql.vectorized.ColumnarBatch.Row>
       |    rowIterator() {
