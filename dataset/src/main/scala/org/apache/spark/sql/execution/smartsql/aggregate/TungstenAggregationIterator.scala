...
class TungstenAggregationIterator(
  ...
  private val spillSizeBefore = 1024 * 64
  ...
  private[this] val hashMap = new AUnsafeFixedWidthAggregationMap(
  ...
  private[this] var externalSorter: AUnsafeKVExternalSorter = null
  ...
  private[this] var sortedKVIterator: AUnsafeKVExternalSorter#KVSorterIterator = null
