 ...
 */
public final class AUnsafeFixedWidthAggregationMap {
...
//    if(schema == null || schema.isEmpty()) return false;
   ...
   */
  public AUnsafeFixedWidthAggregationMap(
   ...
   */
  public AUnsafeKVExternalSorter destructAndCreateExternalSorter() throws IOException {
    return new AUnsafeKVExternalSorter(
      groupingKeySchema,
