...
import org.apache.spark.sql.execution.AUnsafeKVExternalSorter
...
class SortBasedAggregator(
  ...
  private def createExternalSorterForInput(): AUnsafeKVExternalSorter = {
    new AUnsafeKVExternalSorter(
      groupingSchema,
      inputSchema,
