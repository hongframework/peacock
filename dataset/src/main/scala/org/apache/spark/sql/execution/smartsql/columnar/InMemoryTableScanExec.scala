...
package org.apache.spark.sql.execution.smartsql.columnar
...
import org.apache.spark.sql.execution.smartsql.LeafExecNode
...
//    "numOutputRows" -> SQLMetrics.createMetric(sparkContext, "number of output rows"))
  ...
  lazy val enableAccumulators: Boolean =false
//    sqlContext.getConf("spark.sql.inMemoryTableScanStatistics.enable", "false").toBoolean

  // Accumulators used for testing purposes
  lazy val readPartitions = new org.apache.spark.util.LongAccumulator//sparkContext.longAccumulator
  lazy val readBatches = new org.apache.spark.util.LongAccumulator//sparkContext.longAccumulator
