...
import org.apache.spark.sql.execution.smartsql.aggregate.HashAggregateExec
import org.apache.spark.sql.execution.smartsql.joins.{SortMergeJoinExec, BroadcastHashJoinExec}
...
import org.apache.spark.sql.execution.smartsql.aggregate.HashAggregateExec
import org.apache.spark.sql.execution.smartsql.joins.{BroadcastHashJoinExec, SortMergeJoinExec}
...
//    case _: DataSourceScanExec => "scan"
   ...
   */
  def inputRDDs(): Seq[ResultSet[InternalRow]]
...
case class InputAdapter(child: SparkPlan) extends UnaryExecNode with CodegenSupport {
  ...
  override def doExecute(parameters : Map[String, Any] = Map.empty[String, Any]): ResultSet[InternalRow] = {
...
//      WholeStageCodegenExec.PIPELINE_DURATION_METRIC))
  ...
  def doCodeGen(): (CodegenContext, CodeAndComment) = {
    ...
    val source = s"""
      ...
      final class GeneratedIterator extends org.apache.spark.sql.execution.smartsql.BufferedRowIterator {
  ...
  override def doExecute(parameters : Map[String, Any] = Map.empty[String, Any]): ResultSet[InternalRow] = {
    ...
    try {
      ...
      case e: Exception if !Utils.isTesting && true/*sqlContext.conf.wholeStageFallback*/ =>
        // We should already saw the error message
        logWarning(s"Whole-stage codegen disabled for this plan:\n $treeString")
        return child.execute(parameters)
    }
