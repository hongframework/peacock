...
package org.apache.spark.sql.execution.smartsql.exchange
...
import org.apache.spark.sql.execution.smartsql.{ShuffledRowRDD, ResultSet, SparkPlan}
...
//    "dataSize" -> SQLMetrics.createSizeMetric(sparkContext, "data size"))
   ...
   */
  private[exchange] def prepareShuffleDependency(parameters : Map[String, Any] = Map.empty[String, Any])
    : ResultSet[Product2[Int, InternalRow]] = {
    ShuffleExchange.prepareShuffleDependency(
      child.execute(parameters), child.output, newPartitioning, serializer)
  }
   ...
   */
  private var cachedShuffleRDD: ResultSet[Product2[Int, InternalRow]]  = null
    ...
    if (cachedShuffleRDD == null) {
      cachedShuffleRDD = coordinator match {
        case Some(exchangeCoordinator) =>
          ...
          null
        case _ =>
          val shuffleDependency = prepareShuffleDependency(parameters)
...
object ShuffleExchange {
  ...
  def prepareShuffleDependency(
      rdd: ResultSet[InternalRow],
      outputAttributes: Seq[Attribute],
      newPartitioning: Partitioning,
      serializer: Serializer): ResultSet[Product2[Int, InternalRow]] = {
    val part: Partitioner = newPartitioning match {
      ...
      case RangePartitioning(sortingExpressions, numPartitions) =>
        ...
        //TODO null
        new RangePartitioner(numPartitions, null, ascending = true)
    ...
    val rddWithPartitionIds: ResultSet[Product2[Int, InternalRow]] = {
