...
import org.apache.spark.sql.execution.smartsql.{ResultSet, BinaryExecNode, SparkPlan}
...
import org.apache.spark.sql.execution.smartsql.{BinaryExecNode, CodegenSupport, SparkPlan}
...
//    "numOutputRows" -> SQLMetrics.createMetric(sparkContext, "number of output rows"))
  ...
  protected override def doExecute(parameters : Map[String, Any] = Map.empty[String, Any]): ResultSet[InternalRow] = {
    ...
    streamedPlan.execute(parameters).mapPartitions { streamedIter =>
