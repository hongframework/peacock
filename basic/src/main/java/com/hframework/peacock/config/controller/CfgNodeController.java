...
@Controller
@RequestMapping(value = "/config/cfgNode")
public class CfgNodeController   {
    ...
    public ResultData detail(@ModelAttribute("cfgNode") CfgNode cfgNode){
        logger.debug("request : {},{}", cfgNode.getId(), cfgNode);
        try{
            CfgNode result = null;
            if(cfgNode.getId() != null) {
                result = iCfgNodeSV.getCfgNodeByPK(cfgNode.getId());
            }else {
    ...
    */
    ...
    public ResultData create(@ModelAttribute("cfgNode") CfgNode cfgNode) {
        logger.debug("request : {}", cfgNode);
        try {
            ControllerHelper.setDefaultValue(cfgNode, "id");
    ...
    */
    ...
    public ResultData batchCreate(@RequestBody CfgNode[] cfgNodes) {
        ...
        try {
            ControllerHelper.setDefaultValue(cfgNodes, "id");
